<?php
class Request_productsControllersViet_nam_import_products extends Controllers
{
	...
	function edit()
	{
		...
		if($_SESSION['ad_groupid'] == 1 && $data-> is_import == 2){
			$msg = "Đã chuyển qua trạng duyệt nên bạn không sửa được!";
