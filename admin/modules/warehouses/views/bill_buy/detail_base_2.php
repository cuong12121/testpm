<div class="col-12 col-md-6" style="margin-top: 20px;">
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			TemplateHelper::dt_notedit_text(FSText :: _('Loại nhập hàng'),'type_import',$arr_type_import[@$data -> type_import],'','',1,0,0);
			...
			TemplateHelper::dt_notedit_text(FSText :: _('Ghi chú'),'note',@$data -> note,'','',4,0,0);

			TemplateHelper::dt_edit_selectbox('Trạng thái','status',@$data -> status,0,$arr_status_show, $field_value = '', $field_label='');

			$arr_status_buy = $this->  arr_status_buy;

			TemplateHelper::dt_notedit_text(FSText :: _('Tình trạng nhập hàng'),'status_buy',$arr_status_buy[@$data -> status_buy],'','',1,0,0);
