<?php  
	global $toolbar;
	$toolbar->setTitle(FSText :: _('Đóng hàng') );
	// $toolbar->addButton('add',FSText :: _('Add'),'','add.png');
	$toolbar->addButton('packages',FSText :: _('Đóng hàng'),FSText :: _('You must select at least one record'),'box.png');
	$toolbar->addButton('import_excel_packages',FSText :: _('Import excel'),'','Excel-icon.png');
	...
	$filter_package['title'] = FSText::_('Trạng thái'); 
	$filter_package['list'] = array(1=>'Đã đóng',2=>'Chưa đóng');
	$fitler_config['filter'][] = $filter_package;	
	...
	$list_config[] = array('title'=>'Actions','field'=>'id','type'=>'text','col_width' => '20%','arr_params'=>array('function'=>'view_actions'));
...
<script type="text/javascript" src="<?php echo URL_ROOT.LINK_AMIN.'/modules/'.$this->module.'/assets/js/package.js' ?>"></script>
