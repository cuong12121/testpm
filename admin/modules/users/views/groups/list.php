<?php  
	global $toolbar;
	$toolbar->setTitle(FSText :: _('Danh sách nhóm người dùng') );
	...
	//	CONFIG	
	$list_config = array();
	$list_config[] = array('title'=>'Tên nhóm người dùng','field'=>'name','ordering'=> 1, 'type'=>'text','col_width' => '50%','arr_params'=>array('size'=> 30));
