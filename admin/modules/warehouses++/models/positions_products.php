<?php 
class WarehousesModelsPositions_products extends FSModels
{
	var $limit;
	var $prefix ;
	function __construct()
	{
		...
		$this -> table_name = 'fs_warehouses_positions_products';
			// config for save
	...
	function setQuery() {
		...
		{
			$text_positions = $_SESSION[$this -> prefix.'text1'];
			if($text_positions){
				$where .= ' AND ( a.position_name LIKE "%'.$text_positions.'%"  OR a.position_code LIKE "%'.$text_positions.'%") ';
			}
		}
