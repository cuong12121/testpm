<?php 
	class ReasonsModelsReasons extends FSModels
	{
		var $limit;
		var $prefix ;
		function __construct()
		{
			$this -> limit = 10;
			$this -> view = 'reasons';
			$this->table_category_name = 'fs_reasons_categories';
			
			$this -> table_name = 'fs_reasons';
			// config for save
			...
			$this -> img_folder = 'images/reasons';
			$this -> check_alias = 0;
	...
	function get_reason_categories_tree() {
		global $db;
		$sql = " SELECT id, name, parent_id AS parent_id 
				FROM fs_reason_categories
