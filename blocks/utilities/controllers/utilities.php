 ...
 */
	// models 
	include 'blocks/utilities/models/utilities.php';
	class UtilitiesBControllersUtilities extends FSControllers
	{
...
//			// call models
			$model = new UtilitiesBModelsUtilities();
			...
			// call views
			include 'blocks/utilities/views/utilities/'.$style.'.php';
		}
	}
