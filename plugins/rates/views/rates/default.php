...
<div id="rates_rate">
	<div class='rates'>		
		<?php if(isset($data)){ ?>
			<div class='tab_label'><span>Có <strong><?php echo $data -> rates_published ? $data -> rates_published : 0; ?></strong> đánh giá</span> <strong>về <?php echo isset($data -> name)?$data -> name:$data -> title; ?></strong>
