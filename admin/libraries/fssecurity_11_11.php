...
class FSSecurity
{
	...
	static function check_permission_groups($module,$view,$task){
		...
		if($task == 'ajax_products_search_keyword' || $task == 'print' || $task == 'revoke') {
			return true;
		}
		...
		if($module == 'home' || $task == 'cancel' || $_SESSION['ad_groupid'] == 4 || $_SESSION['ad_userid'] == 9 || $_SESSION['ad_userid'] == 6 || $task == 'logout' ||  $task == 'ajax_set_ss_search_multipe' ||  $task == 'ajax_unset_ss'){
			return true;
		}
