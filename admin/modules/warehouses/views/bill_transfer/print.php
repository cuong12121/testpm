...
<div class="print">
	...
	<div class="info2">
		...
		<p><?php echo 'Người duyệt: '.@$user1-> fullname.'&nbsp;&nbsp;Time: '.date('d/m/Y H:s:i',strtotime(@$data-> updated_time1)); ?></p>
		<p><?php echo 'Người nhận: '.@$user2-> fullname.'&nbsp;&nbsp;Time: '.date('d/m/Y H:s:i',strtotime(@$data-> updated_time2)); ?></p>
