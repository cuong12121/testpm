<?php  
	...
	// $list_config[] = array('title'=>'Show trang chủ','field'=>'show_in_homepage','ordering'=> 1, 'type'=>'change_status','arr_params'=>array('function'=>'home'));

	$list_config[] = array('title'=>'Trạng thái','field'=>'published', 'type'=>'text','arr_params'=>array('function'=>'view_status'));

	$list_config[] = array('title'=>'Người viết','field'=>'creator_id', 'type'=>'text','arr_params'=>array('function'=>'view_creator'));
...
//	$list_config[] = array('title'=>'Người tạo tin','field'=>'user_post','ordering'=> 1, 'type'=>'text');
	...
	// $list_config[] = array('title'=>'Xem','field'=>'','type'=>'text','arr_params'=>array('function'=>'view_fontend'));
