				...
				foreach ($get_list_page_pdf as $item_page_pdf){
					...
					if($_SESSION[$this -> prefix.'filter2'] == 1){
						...
						if(!empty($lzd_content_arr[1])){
							preg_match_all('/[A-Z0-9][A-Z0-9][A-Z0-9][A-Z0-9]+-[A-Z0-9][A-Z0-9]+-[A-Z0-9][A-Z0-9]+-[A-Z0-9][A-Z0-9]+-/', $item_page_pdf-> content, $b);
							if(!empty($b[0])){
								$b[0] = $b[0][count($b[0]) - 1];
							}else{
								preg_match('/[A-Z0-9][A-Z0-9][A-Z0-9][A-Z0-9]+-[A-Z0-9][A-Z0-9]+-[A-Z0-9][A-Z0-9]+-[A-Z0-9][A-Z0-9]+-/', $item_page_pdf-> content, $b);
							}
