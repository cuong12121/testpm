						...
						if(!empty($list_products)) {
							...
							foreach ($list_products as $product) {
								...
								<tr class="products_item_selected" id="products_item_selected_<?php echo $pro-> id; ?>">
									...
									<td><span 11 class="item_title"><?php echo $pro-> name; ?><input type="hidden" name="ajax_products[]" value="<?php echo $pro-> id; ?>"></span></td>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="input">
							<a class="btn btn-primary" style="color: #fff;" target="_blank" href="<?php echo URL_ADMIN.'/import/excel/bill/demo_warehouses_bill.xls';?>">Mẫu thêm mới</a>
						</div>
					</div>
				</div>
				<?php
