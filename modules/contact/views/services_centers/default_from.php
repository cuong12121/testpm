<div class="title_form">Điền thông tin liên hệ</div>
<form method="post" action="#" name="contact" class="form" >
	<div class="contact_table" width="100%">
		...
		<div class="mbl">
			<label><?php echo FSText::_("Lời nhắn");?> *</label>
			<textarea  placeholder="<?php echo FSText::_("Lời nhắn");?>" rows="4" cols="10" name='message' id='message' ><?php echo $message; ?></textarea>
		</div>
		<div class="mbl">
			<a class="btn" href="javascript: void(0)" id='submitbt'>
				<span><?php echo FSText::_("Gửi tin nhắn");?></span>
			</a>
			<!--
