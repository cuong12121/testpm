					...
					<table id="table_products_search_ajax_list" width="100%" bordercolor="#AAA" border="1" class="table table-hover table-striped table-bordered dataTables-example" style="margin-bottom: 0px;">
						...
						if(!empty($list_products)) {
							...
							foreach ($list_products as $product) {
								...
								<td><input type="number" name="ajax_products_reality_<?php echo $pro-> id; ?>" id="ajax_products_reality_<?php echo $pro-> id; ?>" onchange="ajax_products_update(<?php echo $pro-> id; ?>)" value="<?php echo $product-> reality; ?>"></td>
