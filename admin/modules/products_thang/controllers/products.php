...
class ProductsControllersProducts  extends Controllers
{
	...
	function display()
	{
		...
		$manufactories = $model->get_manufactories_tree();
		...
		$breadcrumbs = array();
		$breadcrumbs[] = array(0=>'Danh sách sản phẩm', 1 => 'khjfkgjfkjgfkjg');	
...
//	} 
	...
	function ajax_get_product_name(){
		...
		$model = $this -> model;
		$data = $model->get_records('id <> '.$id.' AND name like "%'.$name.'%"','fs_products','id,name');
