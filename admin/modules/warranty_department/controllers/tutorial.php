...
class WarrantyControllersTutorial extends Controllers
{
	function __construct()
	{
		$this->view = 'tutorial' ; 
		parent::__construct();
		$array_status = array('0'=>'Chưa xử lý','1'=>'Hỗ trợ thành công khách sử dụng SP','2'=>'Hỗ trợ không thành công khách trả hàng','3'=>'Hỗ trợ không thành công khách không trả hàng','4'=>'Đổi sp');
