<?php  
	...
	$list_config[] = array('title'=>'Ngày tạo','field'=>'created_time','ordering'=> 1, 'type'=>'date');
	$list_config[] = array('title'=>'Yêu cầu nhập linh kiện','field'=>'name','ordering'=> 1, 'type'=>'text','col_width' => '15%','arr_params'=>array('size'=> 15));
	$list_config[] = array('title'=>'Mã sản phẩm','field'=>'code_product','ordering'=> 1, 'type'=>'text','col_width' => '12%','arr_params'=>array('size'=> 15));
