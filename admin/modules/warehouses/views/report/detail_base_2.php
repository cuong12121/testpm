	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div class="type d_type_3 <?php if($data-> type != 3) echo 'hide'; ?>">
				<?php TemplateHelper::dt_notedit_text(FSText :: _('Chuyển tới Kho hàng'),'to_warehouses_name',$data-> to_warehouses_name,'','',1,0,0);
				?>
			</div>
			<?php 
			...
			TemplateHelper::dt_edit_selectbox('Tình trạng','status',@$data -> status,0,$arr_status_show, $field_value = '', $field_label='');
