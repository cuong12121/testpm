<table cellspacing="1" class="admintable">
	<div class="row">
        <div class="box-shadow-col cls product-info">
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="row row-code-combo <?php echo @$data->type_id == 9 ? '' : 'hide' ?>">
                    <?php 
                        TemplateHelper::dt_edit_text(FSText :: _('Các mã combo'),'code_combo',@$data -> code_combo,'','',1,0,FSText::_("Mã/số lượng - VD: AAA/1,BBB/2"));
                    ?>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-12 col-lg-6">
                        <?php 
                            TemplateHelper::dt_edit_text(FSText :: _('Giá bán thấp nhất'),'price_min',@$data -> price_min,'','',1,0,"","","col-lg-4","col-lg-8");
                        ?>
                    </div>
                    <div class="col-12 col-lg-6">
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-6 box-shadow-col box-shadow-col-50">
            ...
            include_once 'detail_extend.php';
            ?>
        </div>
    </div>
