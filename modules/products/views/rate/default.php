...
<div id="rate_preview" class="container">
	<div id="rates_rate">
		<div class='rates'>		
			<?php if(isset($data)){ ?>
...
<!-- 		                                        <strong><?php echo format_money($data -> price).''?></strong>
		             ...
		             <?php } ?>
						...
						<div class="<?php echo !$is_mobile?'bcrt':'lcrt'; ?>">
							...
							<b><?php  $total_rate = ($count5*5 + $count4*4 + $count3*3 + $count2*2  + $count1*1); echo $total?round($total_rate/$total,1):0;  ?> <i class="iconcom-star"></i></b>
						<?php if(!$is_mobile){ ?>
