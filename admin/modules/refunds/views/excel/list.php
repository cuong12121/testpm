...
<fieldset id="zone-upload-analytics">
	<legend class="title">Hoàn hàng - Excel</legend>
	<div id="content-form-upload-import-excel">
		<form  action="<?php echo FSRoute::_('index.php?module=refunds&view=excel&task=import_excel'); ?>" method="POST" enctype="multipart/form-data">
			...
			<div class="one-row-input">
				...
				<div class="input">
					...
					<input class="btn  btn-info" type="button" value="Tải mẫu " onclick="location.href='<?php echo FSRoute::_('index.php?module=refunds&view=excel&task=download_file')?>'">
				</div>
			</div>
		</form>
	</div>
