...
<!-- HEAD -->
	...
	TemplateHelper::dt_edit_text(FSText :: _('Mã'),'alias',@$data -> alias,'',60,1,0,FSText::_("Can auto generate"));
	TemplateHelper::dt_edit_text(FSText :: _('Icon SVG'),'icon',@$data -> icon,'',100,4,0);
