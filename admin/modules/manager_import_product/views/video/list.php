<?php  
	...
	$list_config[] = array('title'=>'Ngày','field'=>'date','ordering'=> 1, 'type'=>'datetime','col_width' => '6%');
	...
	$list_config[] = array('title'=>'Mô tả','field'=>'note','type'=>'text','arr_params','col_width' => '22%');
	...
	$list_config[] = array('title'=>'Trạng thái','field'=>'status','type'=>'text','col_width' => '8%','arr_params'=>array('function'=>'view_status'));
	$list_config[] = array('title'=>'Link video','field'=>'link_video','type'=>'text','arr_params','col_width' => '25%');
	
	$list_config[] = array('title'=>'NBH chấm sao','field'=>'star','ordering'=> 1,'col_width' => '6%','type'=>'text','arr_params'=>array('function'=>'view_star'));
	$list_config[] = array('title'=>'QL cho điểm','field'=>'point','ordering'=> 1,'col_width' => '6%','type'=>'text');
    ...
    $list_config[] = array('title'=>'Edit','type'=>'edit','col_width' => '4%');
