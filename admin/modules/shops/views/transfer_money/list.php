<?php  
	global $toolbar;
	$toolbar->setTitle(FSText :: _('Chuyển tiền') );
	...
	$list_config[] = array('title'=>'Số tiền chuyển','field'=>'money','ordering'=> 1, 'type'=>'format_money','col_width' => '20%','arr_params'=>array('size'=> 30));
	$list_config[] = array('title'=>'Tài khoản nhận','field'=>'user_name','type'=>'text','arr_params');
