<?php  
	global $toolbar;
	$toolbar->setTitle(FSText :: _('Vật liệu, chất liệu') );
   ...
   // $list_config[] = array('title'=>'City','field'=>'city_id','ordering'=> 1, 'type'=>'selectbox','arr_params'=>array('size'=>10));
	...
	//$list_config[] = array('title'=>'Hiện tên','field'=>'is_name','ordering'=> 1, 'type'=>'change_status','arr_params'=>array('function'=>'home'));
