...
<div class="products_cat">
	...
	<?php } ?>
		...
		<?php if(!empty($sub_cats)) { 
			...
			?>
			<?php $link_parent_cat= FSRoute::_('index.php?module=products&view=cat&ccode='.$parent_cat->alias.'&cid='.$parent_cat->id.'&Itemid='.$Itemid);?>
			<div class="sub_cats">
				<div class="item_scat">
					<figure>
						<a href="<?php echo $link_parent_cat; ?>" title="Nổi bật">
							<img src="<?php echo URL_ROOT.$config['icon_hot']; ?>" alt="Nổi bật">
						</a>
					</figure>
					<div class="cat_name">
						<a href="<?php echo $link_parent_cat; ?>" title="Nổi bật">Nổi bật</a>
					</div>
				</div>
				<?php $is=0; foreach ($sub_cats as $sub_cat) { 
					...
					<?php if($is==8) { ?>
						<div class="item_scat item_readmore_subcat">
							<figure>
								<a href="<?php echo $link_parent_cat; ?>" class="readmore_subcat" title="Xem thêm">
					...
					<?php } ?>
					<div class="item_scat <?php if($cat-> id == $sub_cat-> id) echo 'item_scat_active '; ?><?php if($is>=8) echo 'item_scat_more hide' ?>">
						<figure>
			...
			<section class='products-cat-frame'> 
				<div class='products-cat-frame-inner'>
					<?php include_once 'default_grid_pk.php';?>
				</div>
