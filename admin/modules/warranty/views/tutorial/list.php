<?php  
	...
	$list_config[] = array('title'=>'Tên khách','field'=>'name_custommer','ordering'=> 1, 'type'=>'text','col_width' => '12%','arr_params'=>array('size'=> 15));
	...
	$list_config[] = array('title'=>'NBH mô tả lỗi','field'=>'note','type'=>'text','arr_params','col_width' => '12%');
	$list_config[] = array('title'=>'Trạng thái','field'=>'status','type'=>'text','arr_params'=>array('function'=>'view_status'),'col_width' => '12%');
	$list_config[] = array('title'=>'Chi tiết lỗi','field'=>'note2','type'=>'text','arr_params','col_width' => '15%');
