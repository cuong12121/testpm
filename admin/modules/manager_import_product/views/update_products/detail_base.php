...
<?php
		TemplateHelper::dt_edit_text(FSText :: _('Nâng cấp gì'),'nang_cap',@$data -> nang_cap,'',100,3,1);
		//TemplateHelper::dt_edit_text(FSText :: _('List 5 link nhà cung cấp'),'link',@$data -> link,'',100,5,1);
		TemplateHelper::dt_edit_text(FSText :: _('Giá sản phẩm'),'price_product',@$data -> price_product,'',100,1,0);
