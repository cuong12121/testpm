<?php 
	class ProductsModelsImage_groups extends FSModels
	{
		function __construct()
		{
			$this -> limit = 20;
			
			$this -> table_name = 'fs_products_image_groups';
			$this -> check_alias = 1;
//			$this -> call_update_sitemap = 0;
			
			$this->img_folder = 'images/extends';
			$this->field_img = 'image';
			$this -> arr_img_paths = array(array('resized',150,150,'cut_image'),array('small',150,150,'cut_image'));
