<?php  
	global $toolbar;
	$toolbar->setTitle(FSText :: _('Hoàn hàng') );
	$toolbar->addButton('import_barcode_refund',FSText :: _('Nhập từ barcode'),'','barcode.png');
	$toolbar->addButton('import_excel_refund',FSText :: _('Import excel'),'','Excel-icon.png');
	$toolbar->addButton('excel_hoan_hang',FSText :: _('Xuất Excel'),'','Excel-icon.png');
	...
	$text_from_date['title'] =  FSText::_('Ngày hoàn từ'); 

	$text_to_date = array();
	$text_to_date['title'] =  FSText::_('Ngày hoàn đến');
	...
	$list_config[] = array('title'=>'Ngày hoàn','field'=>'date_refund','ordering'=> 1, 'type'=>'datetime');
