<?php  
	...
	$list_config[] = array('title'=>'Mã sản phẩm','field'=>'code_product','ordering'=> 1, 'type'=>'text','col_width' => '160px','arr_params'=>array('size'=> 15));
	...
	$list_config[] = array('title'=>'Giá SP mới','field'=>'price_product_new','ordering'=> 1,'col_width' => '70px','type'=>'format_money');

	$list_config[] = array('title'=>'Giá RMB','field'=>'price_rmb','ordering'=> 1,'col_width' => '70px','type'=>'format_money');
	$list_config[] = array('title'=>'Giá sản phẩm cũ','field'=>'price_product_old','ordering'=> 1,'col_width' => '70px','type'=>'format_money');
	$list_config[] = array('title'=>'Giá RMB Cũ','field'=>'price_rmb_old','ordering'=> 1,'col_width' => '70px','type'=>'format_money');

	$list_config[] = array('title'=>'Phí vận chuyển mới','field'=>'price_ship','ordering'=> 1,'col_width' => '70px','type'=>'format_money');
	$list_config[] = array('title'=>'Phí vận chuyển cũ','field'=>'price_ship_old','ordering'=> 1,'col_width' => '70px','type'=>'format_money');
	$list_config[] = array('title'=>'Tối ưu','field'=>'toi_uu','ordering'=> 1,'col_width' => '70px','type'=>'format_money');
	$list_config[] = array('title'=>'Giá dự kiến về Kho','field'=>'price_to_hn','ordering'=> 1,'col_width' => '70px','type'=>'format_money');
	...
	$list_config[] = array('title'=>'Giá dự kiến về kho','field'=>'price_to_hn','col_width' => '70px','ordering'=> 1, 'type'=>'format_money');
	...
	$list_config[] = array('title'=>'Duyệt','field'=>'is_import','type'=>'text','arr_params'=>array('function'=>'view_import'));
