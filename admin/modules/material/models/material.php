<?php 
	class MaterialModelsMaterial extends FSModels
	{
		var $limit;
		var $prefix ;
		function __construct()
		{
			$this -> limit = 10;
			$this -> view = 'material';
			$this->table_category_name = 'fs_material_categories';
			
			$this -> table_name = 'fs_material';
			// config for save
			$this -> arr_img_paths = array(array('resized',150,150,'cut_image'),array('large',600,600,'cut_image'),array('compress',1,1,'compress'));
			$this -> img_folder = 'images/material';
			$this -> check_alias = 0;
