<?php 
class Manager_import_productModelsList_import extends FSModels
{
	var $limit;
	var $prefix ;
	...
	function setQuery() {
		...
		if(isset($_SESSION[$this -> prefix.'text0']))
		{
			...
			if($date_from){
				...
				$where .= ' AND a.ngay_dat_hang >=  "'.$date_new.'" ';
			}
		}
		...
		WHERE status = 2 AND type > 0 AND type <= 5 " . $where . $ordering . " ";
		return $query;
	}
