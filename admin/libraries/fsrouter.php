	...
	static function enURL($url){
		...
		switch($module){
			...
			switch ($view){
				...
				switch ($task){
					case 'edit':
					return $url_first.'users/messages/edit/'.$id;
					case 'add':
					return $url_first.'users/messages/add/'.$id;
					default:
					return $url_first.'users/messages';
				}
				return $url_first.'users/messages';
			...
			switch ($view){
				...
				switch ($task){
					case 'edit':
					return $url_first.'warranty/warranty/edit/'.$id;
					case 'add':
					return $url_first.'warranty/warranty/add/'.$id;
					default:
					return $url_first.'warranty/warranty';
				}
			}
			return $url_first.'warranty/warranty';
			break;
			...
			switch ($view){
				...
				switch ($task){
					case 'edit':
					return $url_first.'built/built/edit/'.$id;
					case 'add':
					return $url_first.'built/built/add/'.$id;
					default:
					return $url_first.'built/built';
				}
			}
			...
			case 'warranty_department':
			switch ($view){
				case 'create_order':
				$id =  isset($array_params['id'])?$array_params['id']: '';
				switch ($task){
					case 'edit':
					return $url_first.'warranty_department/create_order/edit/'.$id;
					case 'add':
					return $url_first.'warranty_department/create_order/add/'.$id;
					default:
					return $url_first.'warranty_department/create_order';
				}
				return $url_first.'warranty_department/create_order';
			}
			return $url_first.'warranty_department/warranty';
			break;
			...
			switch ($view){
				...
				case 'viet_nam_import_products':
				$id =  isset($array_params['id'])?$array_params['id']: '';
				switch ($task){
					case 'edit':
					return $url_first.'request_products/viet_nam_import_products/edit/'.$id;
					case 'add':
					return $url_first.'request_products/viet_nam_import_products/add/'.$id;
					default:
					return $url_first.'request_products/viet_nam_import_products';
				}
				...
				switch ($task){
					case 'edit':
					return $url_first.'request_products/update_products/edit/'.$id;
					case 'add':
					return $url_first.'request_products/update_products/add/'.$id;
					default:
					return $url_first.'request_products/update_products';
				}
			}
			return $url_first.'request_products/import_products';
			break;
			...
			switch ($view){
				...
				switch ($task){
					case 'edit':
					return $url_first.'manager_import_product/viet_nam_import_products/edit/'.$id;
					case 'add':
					return $url_first.'manager_import_product/viet_nam_import_products/add/'.$id;
					default:
					return $url_first.'manager_import_product/viet_nam_import_products';
				}
				...
				switch ($task){
					case 'edit':
					return $url_first.'manager_import_product/import_products/edit/'.$id;
					case 'add':
					return $url_first.'manager_import_product/import_products/add/'.$id;
					default:
					return $url_first.'manager_import_product/import_products';
				}
				...
				switch ($task){
					case 'edit':
					return $url_first.'manager_import_product/update_products/edit/'.$id;
					case 'add':
					return $url_first.'manager_import_product/update_products/add/'.$id;
					default:
					return $url_first.'manager_import_product/update_products';
				}
				...
				switch ($task){
					case 'edit':
					return $url_first.'manager_import_product/forecast/edit/'.$id;
					case 'add':
					return $url_first.'manager_import_product/forecast/add/'.$id;
					default:
					return $url_first.'manager_import_product/forecast';
				}
				...
				switch ($task){
					case 'edit':
					return $url_first.'manager_import_product/create_order/edit/'.$id;
					case 'add':
					return $url_first.'manager_import_product/create_order/add/'.$id;
					case 'export':
					return $url_first.'manager_import_product/create_order/export';
					default:
					return $url_first.'manager_import_product/create_order';
				}
				...
				switch ($task){
					case 'edit':
					return $url_first.'manager_import_product/list_import/edit/'.$id;
					case 'add':
					return $url_first.'manager_import_product/list_import/add/'.$id;
					case 'export':
					return $url_first.'manager_import_product/list_import/export';
					default:
					return $url_first.'manager_import_product/list_import';
				}
				return $url_first.'manager_import_product/list_import';
			...
			switch ($view){
				...
				switch ($task){
					case 'edit':
					return $url_first.'employee/import_products/edit/'.$id;
					case 'add':
					return $url_first.'employee/import_products/add/'.$id;
					default:
					return $url_first.'employee/import_products';
				}
				...
				switch ($task){
					case 'edit':
					return $url_first.'employee/update_products/edit/'.$id;
					case 'add':
					return $url_first.'employee/update_products/add/'.$id;
					default:
					return $url_first.'employee/update_products';
				}
				...
				switch ($task){
					case 'edit':
					return $url_first.'employee/forecast/edit/'.$id;
					case 'add':
					return $url_first.'employee/forecast/add/'.$id;
					default:
					return $url_first.'employee/forecast';
				}
				...
				switch ($task){
					case 'edit':
					return $url_first.'employee/create_order/edit/'.$id;
					case 'add':
					return $url_first.'employee/create_order/add/'.$id;
					default:
					return $url_first.'employee/create_order';
				}
				return $url_first.'employee/create_order';
				...
				switch ($task){
					case 'edit':
					return $url_first.'employee/list_import/edit/'.$id;
					case 'add':
					return $url_first.'employee/list_import/add/'.$id;
					default:
					return $url_first.'employee/list_import';
				}
				return $url_first.'employee/list_import';
			}
			return $url_first.'employee/import_products';
			...
			switch ($view){
				...
				case 'report':
				return $url_first.'warehouses/report';
				break;
