<?php 
class Manager_import_productModelsForecast extends FSModels
{
	var $limit;
	var $prefix ;
	...
	function save($row = array(), $use_mysql_real_escape_string = 0) {
		...
		$ngay_du_kien_ve_hang = FSInput::get('ngay_du_kien_ve_hang');
		if($ngay_du_kien_ve_hang){
			$row['ngay_du_kien_ve_hang'] = date('Y-m-d',strtotime($ngay_du_kien_ve_hang));
		}
		// dd($row);
