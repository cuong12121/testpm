<div class="col-12 col-md-6" style="margin-top: 20px;">
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			$arr_status_buy = $this->  arr_status_buy;
			...
			TemplateHelper::dt_edit_selectbox('Loại nhập hàng ','type_import',@$data -> type_import,0,$arr_type_import,$field_value = '', $field_label='');

			?>
			<div class="type_import d_type_import_1 <?php if(@$data -> type_import == 2) echo 'hide'; ?>">
				<?php 
			...
			<div class="type_import d_type_import_2 d_type_import_3 d_type_import_4 <?php if(@$data -> type_import == 1) echo 'hide'; ?>" >
				<?php 
			...
			TemplateHelper::dt_edit_selectbox('Trạng thái','status',@$data -> status,0,$arr_status, $field_value = '', $field_label='');
