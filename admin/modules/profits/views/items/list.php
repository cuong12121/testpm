...
<?php  
	global $toolbar;
	$toolbar->setTitle(FSText :: _('Lợi nhuận shop tạm tính') );
			...
			<tbody>
				<?php if(!empty($list)){
					...
					foreach ($list as $item){
						...
						$list_item = $model->get_records('id IN ('.$item->detail_ids.')','fs_order_uploads_detail','count,product_price,total_price,sku_nhanh,sku');
				...
				?>
					<tr>
							...
							<?php if(!empty($list_item)){ ?>
								...
								<table class="table table-hover table-striped table-bordered">
									...
									<tr>
										...
										<td><?php echo format_money($it_dt-> product_price,' đ','0 đ'); ?></td>
										<td><?php echo format_money($it_dt-> total_price,' đ','0 đ'); ?></td>
									</tr>
									<?php } ?>
								</table>
								</div>
						...
						<td><?php echo format_money($item-> total_product_price,' đ','0 đ'); ?></td>
						<td><?php echo format_money($item-> gia_tri_don_hang,' đ','0 đ'); ?></td>
						<td>
							<?php echo format_money($item-> profit,' đ','0 đ'); ?>
